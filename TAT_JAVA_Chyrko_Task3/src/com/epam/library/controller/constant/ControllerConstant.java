...
//    public final static String SUCCESSFUL_OPERATION = " News is successfully added to the catalog";//TODO
    public final static String UNSUCCESSFUL_OPERATION = "Service is currently not available";
